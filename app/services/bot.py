...
AFTER_PHONE = (
    ...
    "После выполнения Ты делишься своими результатами, инсайтами и вопросами "
    "в комментариях к посту.\n\n"
    "Я каждый день разбираю результаты участниц, отвечаю на вопросы, "
    "выделяю важные инсайты и даю направление для дальнейшей работы.\n\n"
    "Так Ты проходишь Трансформацию "
    "через практику, обратную связь и ежедневную работу над собой.\n\n"
    "🌱 Формат: Если Ты - Девушка - Экстраверт, которая заряжается "
    "от взаимодействия с людьми, обсуждения мыслей, инсайтов и обмена энергией.\n\n"
